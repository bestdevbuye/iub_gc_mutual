          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
            <div className="sm:col-span-2 md:col-span-1">
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-300">
                ...
                <a href="mailto:admin@gcmutualbanks.com" className="hover:text-orange-400 break-all">
...
const TransfersPage = () => (
  <DashboardLayout activePage="transfers">
    ...
    >
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 md:p-8 max-w-2xl">
        <form className="space-y-4 sm:space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Transfer Type</label>
            <select className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none text-sm sm:text-base">
          ...
          <button
            type="submit"
            className="w-full bg-green-600 text-white py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-green-700 transition text-sm sm:text-base"
          >
            Continue to Review
          </button>
        </form>
  ...
  <DashboardLayout activePage="security">
    ...
    >
      ...
      <p className="text-xs sm:text-sm text-gray-600 mt-4">
        For assistance, contact <strong>admin@gcmutualbanks.com</strong>
      </p>
    </motion.div>
  </DashboardLayout>
);
